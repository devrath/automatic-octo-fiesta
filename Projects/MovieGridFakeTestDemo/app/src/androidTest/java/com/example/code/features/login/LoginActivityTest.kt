...
class LoginActivityTest{
    ...
    fun checkForEmptyUserName() {
        ...
        // ASSERT
        assertOnErrorText(getString(R.string.msg_username_empty))
    }
    ...
    fun checkForEmptyPassword() {
        ...
        // ASSERT
        assertOnErrorText(getString(R.string.msg_password_empty))
    }
    ...
    fun check_scenario_when_user_name_is_invalid() {
        ...
        // ASSERT
        assertOnErrorText(getString(R.string.msg_username_incorrect))
    }
    ...
    fun check_scenario_when_password_is_invalid() {
        ...
        // ASSERT
        assertOnErrorText(getString(R.string.msg_password_incorrect))
    }
